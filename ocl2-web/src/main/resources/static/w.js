...
app.controller('controller', function($scope, $http) {
    ...
    $scope.seasons = [2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021];
    $scope.startSeason = 2006;
    $scope.endSeason = 2021;
    $scope.teamName = 'all';
...
//    ];
    ...
    $scope.read = function(index, playerNumber) {
        ...
        $http.get('player/' + playerNumber)
            .then(function(response) {
                var answer = rangeOfScoringPeriodsWithPoints(2005, 2021, response.data.gameStats);
